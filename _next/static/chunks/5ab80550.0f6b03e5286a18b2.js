    ...
    12829: (t, e, r) => {
      ...
      var N = Object.defineProperty,
        ...
        R = (t, e) => {
          ...
          if (B) for (var r of B(e)) _.call(e, r) && O(t, r, e[r]);
          return t;
        };
      let k = {
      ...
      async function te({ id: t, topic: e, wcDeepLink: i }) {
        var n;
        try {
          if (!i) return;
      ...
      let ta = !1,
        tl = !1,
        tc = { debug: 1, default: 2, info: 2, warning: 3, error: 4, off: 5 },
        td = tc.default,
        tp = null,
        tm = (function () {
          try {
      ...
      class tv {
        ...
        _log(t, e) {
          ...
          null == tc[r] &&
            ...
            td > tc[r] || console.log.apply(console, e);
        }
        debug(...t) {
        ...
        checkNormalize(t) {
          tm &&
            this.throwError(
              ...
              tv.errors.UNSUPPORTED_OPERATION,
              { operation: "String.prototype.normalize", form: tm }
            );
        }
        checkSafeUint53(t, e) {
          "number" == typeof t &&
            ...
            (t < 0 || t >= 0x1fffffffffffff) &&
              this.throwError(e, tv.errors.NUMERIC_FAULT, {
        ...
        checkArgumentCount(t, e, r) {
          (r = r ? ": " + r : ""),
            t < e &&
              this.throwError(
                "missing argument" + r,
                tv.errors.MISSING_ARGUMENT,
                { count: t, expectedCount: e }
              ),
            t > e &&
              this.throwError(
                "too many arguments" + r,
                tv.errors.UNEXPECTED_ARGUMENT,
                { count: t, expectedCount: e }
              );
        }
        checkNew(t, e) {
          (t === Object || null == t) &&
            this.throwError("missing new", tv.errors.MISSING_NEW, {
              name: e.name,
            });
        }
        checkAbstract(t, e) {
      ...
      function tM(t, e) {
        ...
        if (
          ...
          r.length % 2 &&
            ("left" === e.hexPad
              ...
              : "right" === e.hexPad
              ? (r += "0")
              : tb.throwArgumentError("hex data is odd-length", "value", t));
          let i = [];
        ...
        return tx(t)
          ? ty(new Uint8Array(t))
          : tb.throwArgumentError("invalid arrayify value", "value", t);
      }
      function tE(t, e) {
        return !(
          "string" != typeof t ||
      ...
      function tN(t, e, r) {
        return (
          "string" != typeof t
            ? (t = tI(t))
            : (!tE(t) || t.length % 2) &&
              tb.throwArgumentError("invalid hexData", "value", t),
          (e = 2 + 2 * e),
      ...
      function tB(t, e) {
        for (
          "string" != typeof t
            ? (t = tI(t))
            : tE(t) || tb.throwArgumentError("invalid hex string", "value", t),
            t.length > 2 * e + 2 &&
        ...
        if ((tE(t) && !(t.length % 2)) || tx(t)) {
          ...
          64 === r.length
            ? ((e.v = 27 + (r[32] >> 7)),
              (r[32] &= 127),
              (e.r = tI(r.slice(0, 32))),
              (e.s = tI(r.slice(32, 64))))
            : 65 === r.length
            ? ((e.r = tI(r.slice(0, 32))),
              (e.s = tI(r.slice(32, 64))),
              (e.v = r[64]))
            : tb.throwArgumentError("invalid signature string", "signature", t),
            e.v < 27 &&
              (0 === e.v || 1 === e.v
                ? (e.v += 27)
                : tb.throwArgumentError(
          ...
          let r = tM(e.s);
          r[0] >= 128 &&
            tb.throwArgumentError("signature s out of range", "signature", t),
            e.recoveryParam && (r[0] |= 128);
          let i = tI(r);
          e._vs &&
            (tE(e._vs) ||
              tb.throwArgumentError("signature invalid _vs", "signature", t),
            (e._vs = tB(e._vs, 32))),
            null == e._vs
              ? (e._vs = i)
              : e._vs !== i &&
      ...
      !(function (t, e) {
        ...
        var m = function (t, e, r) {
          ...
          (h = (((o + (n >>> 13)) | 0) + (tv >>> 26)) | 0),
            ...
            (o = (o + Math.imul(m, Q)) | 0),
            (i = (i + Math.imul(l, J)) | 0),
            (n = ((n = (n + Math.imul(l, Y)) | 0) + Math.imul(c, J)) | 0),
            (o = (o + Math.imul(c, Y)) | 0);
          ...
          (h = (((o + (n >>> 13)) | 0) + (tA >>> 26)) | 0),
            ...
            (o = (o + Math.imul(w, Q)) | 0),
            (i = (i + Math.imul(v, J)) | 0),
            (n = ((n = (n + Math.imul(v, Y)) | 0) + Math.imul(b, J)) | 0),
            (o = (o + Math.imul(b, Y)) | 0),
            (i = (i + Math.imul(p, W)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tw >>> 26)) | 0),
            ...
            (o = (o + Math.imul(N, Q)) | 0),
            (i = (i + Math.imul(M, J)) | 0),
            (n = ((n = (n + Math.imul(M, Y)) | 0) + Math.imul(E, J)) | 0),
            (o = (o + Math.imul(E, Y)) | 0),
            (i = (i + Math.imul(y, W)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tx >>> 26)) | 0),
            ...
            (o = (o + Math.imul(_, Q)) | 0),
            (i = (i + Math.imul(I, J)) | 0),
            (n = ((n = (n + Math.imul(I, Y)) | 0) + Math.imul(N, J)) | 0),
            (o = (o + Math.imul(N, Y)) | 0),
            (i = (i + Math.imul(M, W)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tM >>> 26)) | 0),
            ...
            (o = (o + Math.imul(k, Q)) | 0),
            (i = (i + Math.imul(C, J)) | 0),
            (n = ((n = (n + Math.imul(C, Y)) | 0) + Math.imul(_, J)) | 0),
            (o = (o + Math.imul(_, Y)) | 0),
            (i = (i + Math.imul(I, W)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tE >>> 26)) | 0),
            ...
            (o = (o + Math.imul(T, Q)) | 0),
            (i = (i + Math.imul(R, J)) | 0),
            (n = ((n = (n + Math.imul(R, Y)) | 0) + Math.imul(k, J)) | 0),
            (o = (o + Math.imul(k, Y)) | 0),
            (i = (i + Math.imul(C, W)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tI >>> 26)) | 0),
            (tI &= 0x3ffffff),
            (i = Math.imul(F, J)),
            (n = ((n = Math.imul(F, Y)) + Math.imul(q, J)) | 0),
            (o = Math.imul(q, Y)),
            (i = (i + Math.imul(U, W)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tR >>> 26)) | 0),
            (tR &= 0x3ffffff),
            (i = Math.imul(F, tl)),
            (n = ((n = Math.imul(F, tc)) + Math.imul(q, tl)) | 0),
            (o = Math.imul(q, tc)),
      ...
      class tq {
        ...
        div(t) {
          return (
            tq.from(t).isZero() && tH("division-by-zero", "div"),
            tz(tj(this).div(tj(t)))
          );
        }
        mul(t) {
        ...
        mod(t) {
          let e = tj(t);
          return (
            e.isNeg() && tH("division-by-zero", "mod"), tz(tj(this).umod(e))
          );
        }
        pow(t) {
          let e = tj(t);
        ...
        xor(t) {
          ...
          return (
            (this.isNegative() || e.isNeg()) &&
              tH("unbound-bitwise-result", "xor"),
            tz(tj(this).xor(e))
          );
        }
        mask(t) {
          return (
            (this.isNegative() || t < 0) && tH("negative-width", "mask"),
            tz(tj(this).maskn(t))
          );
        }
        shl(t) {
          return (
            (this.isNegative() || t < 0) && tH("negative-width", "shl"),
            tz(tj(this).shln(t))
          );
        }
        shr(t) {
          return (
            (this.isNegative() || t < 0) && tH("negative-width", "shr"),
            tz(tj(this).shrn(t))
          );
        }
        eq(t) {
        ...
        static from(t) {
          ...
          if ("string" == typeof t)
            return t.match(/^-?0x[0-9a-f]+$/i)
              ? new tq(tD, tL(t))
              : t.match(/^-?[0-9]+$/)
              ? new tq(tD, tL(new tU(t)))
              : tT.throwArgumentError("invalid BigNumber string", "value", t);
          if ("number" == typeof t)
            return (
              t % 1 && tH("underflow", "BigNumber.from", t),
              (t >= 0x1fffffffffffff || t <= -0x1fffffffffffff) &&
                tH("overflow", "BigNumber.from", t),
              tq.from(String(t))
            );
      ...
      function tL(t) {
        ...
        if ("-" === t[0])
          return (
            "-" === (t = t.substring(1))[0] &&
              tT.throwArgumentError("invalid hex", "value", t),
            "0x00" === (t = tL(t)) ? t : "-" + t
          );
      ...
      function tj(t) {
        ...
        return "-" === e[0]
          ? new tU("-" + e.substring(3), 16)
          : new tU(e.substring(2), 16);
      }
      function tH(t, e, r) {
        let i = { fault: t, operation: e };
        return (
          null != r && (i.value = r),
          tT.throwError(t, tv.errors.NUMERIC_FAULT, i)
        );
      }
      let tK = new tv(tP),
        tQ = {},
      ...
      function tY(t, e, r, i) {
        ...
        return (
          void 0 !== i && (n.value = i),
          tK.throwError(t, tv.errors.NUMERIC_FAULT, n)
        );
      }
      let tV = "0";
      ...
      function tW(t) {
        ...
        return "number" == typeof t && t >= 0 && t <= 256 && !(t % 1)
          ? "1" + tV.substring(0, t)
          : tK.throwArgumentError("invalid decimal size", "decimals", t);
      }
      function tX(t, e) {
        null == e && (e = 0);
        let r = tW(e),
      ...
      function tZ(t, e) {
        ...
        ("string" == typeof t && t.match(/^-?[0-9.]+$/)) ||
          tK.throwArgumentError("invalid decimal value", "value", t);
        let i = "-" === t.substring(0, 1);
        i && (t = t.substring(1)),
          "." === t && tK.throwArgumentError("missing value", "value", t);
        let n = t.split(".");
        n.length > 2 &&
          tK.throwArgumentError("too many decimal points", "value", t);
        let o = n[0],
          f = n[1];
          ...
          if ("string" == typeof t) {
            if ("fixed" !== t) {
              if ("ufixed" === t) e = !1;
                ...
                n || tK.throwArgumentError("invalid fixed format", "format", t),
                  (e = "u" !== n[1]),
                  (r = parseInt(n[2])),
                  (i = parseInt(n[3]));
              }
      ...
      class t0 {
        ...
        floor() {
          ...
          let e = t0.from(t[0], this.format),
            r = !t[1].match(/^(0*)$/);
          return (
            this.isNegative() && r && (e = e.subUnsafe(t1.toFormat(e.format))),
            e
          );
        }
        ceiling() {
          ...
          let e = t0.from(t[0], this.format),
            r = !t[1].match(/^(0*)$/);
          return (
            !this.isNegative() && r && (e = e.addUnsafe(t1.toFormat(e.format))),
            e
          );
        }
        round(t) {
          ...
          if (
            (1 === e.length && e.push("0"),
            (t < 0 || t > 80 || t % 1) &&
              tK.throwArgumentError("invalid decimal count", "decimals", t),
            e[1].length <= t)
          )
            return this;
        ...
        toHexString(t) {
          return null == t
            ? this._hex
            : (t % 8 && tK.throwArgumentError("invalid byte width", "width", t),
              tB(
                tq
                  .from(this._hex)
        ...
        static fromString(t, e) {
          ...
          !r.signed &&
            i.lt(tG) &&
            tY("unsigned value cannot be negative", "overflow", "value", t);
          let n = null;
          return new t0(
            tQ,
            r.signed
              ? i.toTwos(r.width).toHexString()
              : tB(i.toHexString(), r.width / 8),
            tX(i, r.decimals),
            r
          );
        }
...
`;
      ...
      for (let t = 0; t < 26; t++)
        eu[String.fromCharCode(65 + t)] = String(10 + t);
      let eh = Math.floor(
        Math.log10
      ...
      tq.from(
        ...
        tB(ec.toHexString(), 32),
        tB(el.toHexString(), 32);
      var ed = {},
        ep = {};
      function em(t, e) {
        if (!t) throw Error(e || "Assertion failed");
      ...
      (ew.BlockHash = ex),
        (ex.prototype.update = function (t, e) {
          if (
            ((t = ep.toArray(t, e)),
            this.pending
            ...
            (this.pending = t.slice(t.length - r, t.length)),
              ...
              (t = ep.join32(t, 0, t.length - r, this.endian));
        ...
        (ex.prototype.digest = function (t) {
          return (
            this.update(this._pad()), em(null === this.pending), this._digest(t)
          );
        }),
      ...
      ep.inherits(ek, eO),
        ...
        (ek.prototype._update = function (t, e) {
          ...
          for (; i < r.length; i++)
            r[i] = eN(r[i - 3] ^ r[i - 8] ^ r[i - 14] ^ r[i - 16], 1);
          var n = this.h[0],
            o = this.h[1],
            f = this.h[2],
            s = this.h[3],
          ...
          (this.h[0] = eB(this.h[0], n)),
            (this.h[1] = eB(this.h[1], o)),
            (this.h[2] = eB(this.h[2], f)),
            (this.h[3] = eB(this.h[3], s)),
            (this.h[4] = eB(this.h[4], u));
        }),
        (ek.prototype._digest = function (t) {
          return "hex" === t
            ? ep.toHex32(this.h, "big")
            : ep.split32(this.h, "big");
        });
      var eP = ep.sum32,
        eU = ep.sum32_4,
        eT = ep.sum32_5,
      ...
      ep.inherits(eQ, eH),
        ...
        (eQ.prototype._update = function (t, e) {
          for (var r = this.W, i = 0; i < 16; i++) r[i] = t[e + i];
          for (; i < r.length; i++)
            r[i] = eU(ej(r[i - 2]), r[i - 7], ez(r[i - 15]), r[i - 16]);
          var n = this.h[0],
            o = this.h[1],
            f = this.h[2],
            s = this.h[3],
        ...
        (eG.prototype._digest = function (t) {
          return "hex" === t
            ? ep.toHex32(this.h.slice(0, 7), "big")
            : ep.split32(this.h.slice(0, 7), "big");
        });
      var eJ = ep.rotr64_hi,
        eY = ep.rotr64_lo,
        eV = ep.shr64_hi,
      ...
      ep.inherits(e5, e6),
        ...
        (e5.prototype._prepareBlock = function (t, e) {
          ...
          for (; i < r.length; i += 2) {
            var n = (function (t, e) {
              ...
              a = r[i - 32],
              l = r[i - 31];
            (r[i] = e0(n, o, f, s, u, h, a, l)),
              (r[i + 1] = e1(n, o, f, s, u, h, a, l));
          }
        }),
        ...
        (e4.prototype._digest = function (t) {
          return "hex" === t
            ? ep.toHex32(this.h.slice(0, 12), "big")
            : ep.split32(this.h.slice(0, 12), "big");
        }),
        (eM.sha1 = ek),
        (eM.sha224 = eG),
        (eM.sha256 = eQ),
      ...
      ep.inherits(rn, ri),
        ...
        (rn.prototype._update = function (t, e) {
          ...
          (m = re(this.h[1], n, a)),
            (this.h[1] = re(this.h[2], o, l)),
            (this.h[2] = re(this.h[3], f, s)),
            (this.h[3] = re(this.h[4], r, u)),
            (this.h[4] = re(this.h[0], i, h)),
            (this.h[0] = m);
        }),
        (rn.prototype._digest = function (t) {
          return "hex" === t
            ? ep.toHex32(this.h, "little")
            : ep.split32(this.h, "little");
        });
      var rf = [
      ...
      function rA(t, e) {
        (this.type = t),
          (this.p = new tk(e.p, 16)),
          (this.red = e.prime ? tk.red(e.prime) : tk.mont(this.p)),
          (this.zero = new tk(0).toRed(this.red)),
          (this.one = new tk(1).toRed(this.red)),
          (this.two = new tk(2).toRed(this.red)),
          (this.n = e.n && new tk(e.n, 16)),
        ...
        (rA.prototype._wnafMulAdd = function (t, e, r, i, n) {
          ...
          for (o = i - 1; o >= 1; o -= 2) {
            var d = o - 1,
              p = o;
            if (1 !== u[d] || 1 !== u[p]) {
              (a[d] = rg(r[d], u[d], this._bitLength)),
                (a[p] = rg(r[p], u[p], this._bitLength)),
      ...
      var rw = rl(function (t) {
        ...
        rx = rm.assert;
      function rM(t) {
        rA.call(this, "short", t),
          (this.a = new tk(t.a, 16).toRed(this.red)),
          (this.b = new tk(t.b, 16).toRed(this.red)),
      ...
      function rE(t, e, r, i) {
        rA.BasePoint.call(this, t, "affine"),
          null === e && null === r
      ...
      function rS(t, e, r, i) {
        rA.BasePoint.call(this, t, "jacobian"),
      ...
      rw(rM, rA),
        (rM.prototype._getEndomorphism = function (t) {
          if (!(!this.zeroA || !this.g || !this.n || 1 !== this.p.modn(3))) {
            ...
            if (t.lambda) r = new tk(t.lambda, 16);
              ...
              0 === this.g.mul(o[0]).x.cmp(this.g.x.redMul(e))
                ? (r = o[0])
                : ((r = o[1]),
                  rx(0 === this.g.mul(r).x.cmp(this.g.x.redMul(e))));
            }
            return (
              (i = t.basis
                ? t.basis.map(function (t) {
                    return { a: new tk(t.a, 16), b: new tk(t.b, 16) };
                  })
        ...
        rw(rE, rA.BasePoint),
        (rM.prototype.point = function (t, e, r) {
        ...
        rw(rS, rA.BasePoint),
        (rM.prototype.jpoint = function (t, e, r) {
      ...
      (rB.prototype._init = function (t, e, r) {
        ...
        (rB.prototype.generate = function (t, e, r, i) {
          ...
          "string" != typeof e && ((i = r), (r = e), (e = null)),
            r && ((r = rp.toArray(r, i || "hex")), this._update(r));
      ...
      (r_.fromPublic = function (t, e, r) {
        return e instanceof r_ ? e : new r_(t, { pub: e, pubEnc: r });
      }),
        (r_.fromPrivate = function (t, e, r) {
          return e instanceof r_ ? e : new r_(t, { priv: e, privEnc: r });
        }),
        ...
        (r_.prototype._importPrivate = function (t, e) {
          (this.priv = new tk(t, e || 16)),
            (this.priv = this.priv.umod(this.ec.curve.n));
        }),
        (r_.prototype._importPublic = function (t, e) {
          if (t.x || t.y) {
            "mont" === this.ec.curve.type
              ? rC(t.x, "Need x coordinate")
              : ("short" === this.ec.curve.type ||
                  "edwards" === this.ec.curve.type) &&
                rC(t.x && t.y, "Need both x and y coordinate"),
        ...
        (r_.prototype.derive = function (t) {
          return (
            t.validate() || rC(t.validate(), "public point not validated"),
      ...
      function rR(t, e) {
        ...
        this._importDER(t, e) ||
          (rO(t.r && t.s, "Signature without r or s"),
          (this.r = new tk(t.r, 16)),
          (this.s = new tk(t.s, 16)),
      ...
      function rq(t) {
        ...
        "string" == typeof t &&
          (rF(
            Object.prototype.hasOwnProperty.call(rN, t),
            "Unknown curve " + t
          ),
          (t = rN[t])),
          t instanceof rN.PresetCurve && (t = { curve: t }),
      ...
      (rq.prototype.keyPair = function (t) {
        ...
        (rq.prototype.sign = function (t, e, r, i) {
          "object" == typeof r && ((i = r), (r = null)),
            ...
            (t = this._truncateToN(new tk(t, 16)));
          for (
                  ...
                  if (0 !== (p = p.umod(this.n)).cmpn(0)) {
                    ...
                    return (
                      i.canonical &&
                        p.cmp(this.nh) > 0 &&
                        ((p = this.n.sub(p)), (m ^= 1)),
                      new rR({ r: d, s: p, recoveryParam: m })
                    );
                  }
                }
              }
        ...
        (rq.prototype.recoverPubKey = function (t, e, r, i) {
          rF((3 & r) === r, "The recovery param is more than two bits"),
            (e = new rR(e, i));
          var n = this.n,
            o = new tk(t),
            f = e.r,
      ...
      class rK {
        ...
        signDigest(t) {
          let e = rH().keyFromPrivate(tM(this.privateKey)),
            r = tM(t);
          32 !== r.length &&
            rz.throwArgumentError("bad digest length", "digest", t);
      ...
      function rQ(t, e) {
        ...
        if (32 === r.length) {
          let t = new rK(r);
          return e
            ? "0x" + rH().keyFromPrivate(r).getPublic(!0, "hex")
            : t.publicKey;
        }
        return 33 === r.length
          ? e
            ? tI(r)
            : "0x" + rH().keyFromPublic(r).getPublic(!1, "hex")
          : 65 === r.length
          ? e
            ? "0x" + rH().keyFromPublic(r).getPublic(!0, "hex")
            : tI(r)
          : rz.throwArgumentError(
          ...
          case "eip191":
            ...
            return (
              ...
              (function (t) {
                ...
                if (
                  ("string" != typeof t &&
                    ef.throwArgumentError("invalid address", "address", t),
                  ...
                  for (
                    t.substring(2, 4) !==
                      ...
                      ef.throwArgumentError("bad icap checksum", "address", t),
                      e = new tU(t.substring(4), 36).toString(16);
                    e.length < 40;
                      ...
                      rQ(
                        (function (t, e) {
                          ...
                          return (
                            "0x" +
                            rH()
                              .recoverPubKey(tM(t), i, r.recoveryParam)
                              .encode("hex", !1)
                          );
                        })(tM(eo(e)), f)
                      ),
      ...
      var rY = Object.defineProperty,
        ...
        r1 = (t, e) => {
          ...
          if (rX) for (var r of rX(e)) r$.call(e, r) && r0(t, r, e[r]);
          return t;
        },
        r2 = (t, e) => rV(t, rW(e));
      let r3 = (t) => t?.split(":"),
...
`)
      ...
      function iE(t, e) {
        ...
        return iN({ type: r, sealed: (0, b.sH)(t, id), iv: i, encoding: e });
      }
      function iS(t) {
      ...
      function iI(t, e) {
        let { sealed: r } = iB({ encoded: t, encoding: e });
        return (0, b.dI)(r, id);
      }
      function iN(t) {
        let { encoding: e = il } = t;
        if (ix(t.type) === im)
          return (0, b.dI)((0, b.xW)([t.type, t.sealed]), e);
        if (ix(t.type) === ip) {
          if (typeof t.senderPublicKey > "u")
            throw Error("Missing sender public key for type 1 envelope");
          return (0, b.dI)(
            (0, b.xW)([t.type, t.senderPublicKey, t.iv, t.sealed]),
            e
          );
        }
      ...
      function iC(t, e) {
        let r = iB({ encoded: t, encoding: e?.encoding });
        return i_({
          type: ix(r.type),
          senderPublicKey:
            "u" > typeof r.senderPublicKey
              ? (0, b.dI)(r.senderPublicKey, ia)
              : void 0,
      ...
      var iT = Object.defineProperty,
        ...
        iH = (t, e) => {
          ...
          if (iq) for (var r of iq(e)) iz.call(e, r) && ij(t, r, e[r]);
          return t;
        },
        iK = (t, e) => iD(t, iF(e));
      function iQ(t) {
      ...
      function i6(t, e) {
        ...
        for (let [e, i] of Object.entries(r))
          i.methods ? (i.methods = tt(i.methods, t)) : (i.methods = t),
      ...
      function na(t) {
        let e = !0;
        return (
          i7(t) ? t.length && (e = t.every((t) => nr(t, !1))) : (e = !1), e
        );
      }
      function nl(t, e) {
        let r = null;
      ...
      Approved: ${s.toString()}`
        ...
        Approved: ${n.toString()}`
          ...
          f.forEach((t) => {
            i ||
              (j(n[t].methods, o[t].methods)
                ? j(n[t].events, o[t].events) ||
                  (i = i4(
                    "NON_CONFORMING_NAMESPACES",
