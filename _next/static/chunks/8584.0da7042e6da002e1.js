          ...
          (function (t, e, r, i) {
            ...
            let v = (function (t, e, r) {
                ...
                return (function (t, e, r) {
                  ...
                  for (i = 0; i < x; i++)
                    for (n = 0; n < s; n++)
                      i < b[n].length && (A[C++] = b[n][i]);
                  for (i = 0; i < f; i++)
                    for (n = 0; n < s; n++) A[C++] = y[n][i];
                  return A;
                })(i, t, e);
              })(e, r, m),
    ...
    68584: (t, e, r) => {
      ...
      class x extends HTMLElement {
        ...
        requestUpdate(t, e, r) {
          ...
          void 0 !== t &&
            ((
              (r = r || this.constructor.getPropertyOptions(t)).hasChanged || v
            )(this[t], e)
...
\f\r"'\`<>=]|("|')|))|$)`,
        ...
        for (let e = 0; e < r; e++) {
          ...
          n +=
            l === N
              ? r + O
              : c >= 0
              ? (o.push(a), r.slice(0, c) + E + r.slice(c) + k + h)
            ...
            if (1 === o.nodeType) {
              if (o.hasAttributes()) {
                ...
                for (let e of o.getAttributeNames())
                  if (e.endsWith(E) || e.startsWith(k)) {
                    let r = c[n++];
                    if ((t.push(e), void 0 !== r)) {
                      let t = o.getAttribute(r.toLowerCase() + E).split(k),
                        e = /([.?@])?(.*)/.exec(r);
                      a.push({
                        type: 1,
                        index: i,
      ...
      class te {
        ...
        _$AI(t, e = this, r, o) {
          let i = this.strings,
            n = !1;
          if (void 0 === i)
            (n = !M((t = G(this, t, e, 0))) || (t !== this._$AH && t !== V)) &&
              (this._$AH = t);
          else {
            let o, l;
            let a = t;
      ...
      class tn extends te {
        ...
        _$AI(t, e = this) {
          var r;
          if (
            (t = null !== (r = G(this, t, e, 0)) && void 0 !== r ? r : F) === V
          )
            return;
          let o = this._$AH,
            i =
      ...
      null == ta || ta(Q, tt),
        (null !== (ty = $.litHtmlVersions) && void 0 !== ty
          ? ty
          : ($.litHtmlVersions = [])
        ).push("2.8.0");
      let ts = (t, e, r) => {
          ...
          get: (t, e) => {
            ...
            switch (e) {
              case "duration":
                return t.duration;
              case "currentTime":
                return tk.s((null == r ? void 0 : r[e]) || 0);
              case "playbackRate":
              case "playState":
              ...
              case "finished":
                return (
                  t.finished ||
                    (t.finished = Promise.all(t.animations.map(tL)).catch(t_)),
                  t.finished
                );
              case "stop":
                return () => {
          ...
          let d = (function (
            ...
            return (
              ...
              (i) => {
                ...
                return (
                  (a = ((n = l), tj(r) ? r[tW(0, r.length, n)] : r)(a)),
                  tD(t[l], t[l + 1], a)
                );
              }
            );
          })(e, a, tj(r) ? r.map(tJ) : tO);
          (this.tick = (e) => {
            var r;
            let o = 0;
            (o =
      ...
      ["translate", "scale", "rotate", "skew"].forEach((t) => {
        t2.forEach((e) => {
          t8.push(t + e), t7.set(t6(t + e), t3[t]);
        });
      });
      let t9 = (t, e) => t8.indexOf(t) - t8.indexOf(e),
        ...
        es = {
          ...
          finished: () =>
            !!ea({ opacity: [0, 1] }, { duration: 0.001 }).finished,
          linearEasing: () => {
            try {
      ...
      let ef = {
        ...
        eb = function (t, e, r = {}) {
          ...
          tG(!!l, "No valid element provided."),
            tG(!!e, "No keyframes defined.");
          let a = [];
          for (let o = 0; o < l; o++) {
            let s = t[o];
            for (let t in e) {
              let c = ev(r, t);
              c.delay = ((i = c.delay), (n = o), tF(i) ? i(n, l) : i);
                      ...
                      (l = t.animate(
                        {
                          [$]: b,
                          offset: f,
                          easing: tj(m) ? m.map((t) => eu(t, c)) : void 0,
                        },
                        e
                      )).finished ||
      ...
      var e$ = r(89683),
        ...
        e_ = (t, e, r) =>
          e in t
            ...
            : (t[e] = r),
        eO = (t, e) => {
          for (var r in e || (e = {})) eE.call(e, r) && e_(t, r, e[r]);
          if (eC) for (var r of eC(e)) ek.call(e, r) && e_(t, r, e[r]);
          return t;
        };
      function eI() {
        return {
      ...
      let eN = class extends tc {
        ...
        render() {
          ...
          return (
            ...
            z`<button class="${tv(t)}" ?disabled="${this.disabled}" @click="${
              this.onClick
            }">${
              this.iconLeft
      ...
      let eU = class extends tc {
        ...
        render() {
          ...
          return z`<button ?disabled="${this.disabled}" class="${tv(
            t
          )}"><slot></slot></button>`;
        }
      };
      ...
      let eJ = d`main{padding:20px;padding-top:0;width:100%}`;
        ...
        render() {
          let t = { "wcm-border": this.border },
            ...
            r = this.title
              ...
              : z`<slot></slot>`;
          return z`<header class="${tv(t)}">${
            e ? this.backBtnTemplate() : null
          } ${r} ${this.onAction ? this.actionBtnTemplate() : null}</header>`;
        }
      };
      (e8.styles = [eT.globalCss, e4]),
        e6([tp()], e8.prototype, "title", 2),
        e6([tp()], e8.prototype, "onAction", 2),
        e6([tp()], e8.prototype, "actionIcon", 2),
        e6([tp({ type: Boolean })], e8.prototype, "border", 2),
        (e8 = e6([th("wcm-modal-header")], e8));
      let e9 = {
            ...
            if (t)
              try {
                await navigator.clipboard.writeText(t),
                  tC.dC.openToast("Link copied", "success");
              } catch (t) {
        ...
        constructor() {
          super(),
            ...
            (this.unsubscribe = tC.dC.subscribe((t) => {
              t.open
                ? ((this.open = !0),
                  (this.timeout = setTimeout(() => tC.dC.closeToast(), 2200)))
            ...
            return (
              ...
              Object.entries(u)
                ...
                .forEach(([t, e]) => {
                  e.forEach((e) => {
                    i.push(
                      Z`<circle cx="${t}" cy="${e}" fill="${o}" r="${l / 2.5}">`
                    );
                  });
                }),
              Object.entries(u)
      ...
      let rf = class extends tc {
        ...
        svgTemplate() {
          let t =
            "light" === tC.lH.state.themeMode ? this.size : this.size - 36;
          return Z`<svg height="${t}" width="${t}">${rh.generate(
            this.uri,
            t,
            t / 4
          )}</svg>`;
        ...
        render() {
          ...
          return z`<div style="${`width: ${this.size}px`}" class="${tv(t)}">${
      ...
      (rE.styles = [eT.globalCss, r$]),
        (rE = ((t, e, r, o) => {
          for (
            var i, n = o > 1 ? void 0 : o ? rC(e, r) : e, l = t.length - 1;
            l >= 0;
            l--
          )
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
      ...
      let rN = class extends tc {
        ...
        handleClick() {
          tC.vZ.click({ name: "WALLET_BUTTON", walletId: this.walletId }),
            this.onClick();
        }
        render() {
          var t;
      ...
      rz([tg()], rZ.prototype, "preload", 2),
        (rZ = rz([th("wcm-explorer-context")], rZ));
      var rV = Object.defineProperty,
        rF = Object.getOwnPropertyDescriptor;
      let rK = class extends tc {
        constructor() {
          super(),
      ...
      (rQ.styles = [eT.globalCss, rq]),
        ...
        })([th("wcm-android-wallet-selection")], rQ));
      ...
      (r8.styles = [eT.globalCss, r3]),
        ...
        })([th("wcm-desktop-wallet-selection")], r8));
      ...
      let oh = class extends tc {
        ...
        render() {
          ...
          return z`<wcm-explorer-context></wcm-explorer-context><wcm-theme-context></wcm-theme-context><div id="wcm-modal" class="${tv(
            t
          )}" @click="${
            this.onCloseModal
      ...
      (oO.styles = [eT.globalCss]),
        (oO = ((t, e, r, o) => {
          for (
            var i, n = o > 1 ? void 0 : o ? o_(e, r) : e, l = t.length - 1;
            l >= 0;
            l--
          )
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
      ...
      let oH = class extends tc {
        ...
        onFormatAndRedirect(t, e = !1) {
          ...
          if (
            ((t =
              tC.Ao.isTelegram() && tC.Ao.isAndroid()
      ...
      let oJ = d`wcm-modal-content{height:clamp(200px,60vh,600px);display:block;overflow:scroll;scrollbar-width:none;position:relative;margin-top:1px}.wcm-grid{display:grid;grid-template-columns:repeat(4,80px);justify-content:space-between;margin:-15px -10px;padding-top:20px}wcm-modal-content::after,wcm-modal-content::before{content:'';position:fixed;pointer-events:none;z-index:1;width:100%;height:20px;opacity:1}wcm-modal-content::before{box-shadow:0 -1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(var(--wcm-color-bg-1),rgba(255,255,255,0))}wcm-modal-content::after{box-shadow:0 1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(rgba(255,255,255,0),var(--wcm-color-bg-1));top:calc(100% - 20px)}wcm-modal-content::-webkit-scrollbar{display:none}.wcm-placeholder-block{display:flex;justify-content:center;align-items:center;height:100px;overflow:hidden}.wcm-empty,.wcm-loading{display:flex}.wcm-loading .wcm-placeholder-block{height:100%}.wcm-end-reached .wcm-placeholder-block{height:0;opacity:0}.wcm-empty .wcm-placeholder-block{opacity:1;height:100%}wcm-wallet-button{margin:calc((100% - 60px)/ 3) 0}`;
      ...
      let o0 = class extends tc {
        ...
        render() {
          ...
          return z`<wcm-modal-header><wcm-search-input .onChange="${this.onSearchChange.bind(
            this
          )}"></wcm-search-input></wcm-modal-header><wcm-modal-content class="${tv(
            s
