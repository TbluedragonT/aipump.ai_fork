(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [2361],
  {
    33530: (e, t, n) => {
      ...
      function P(e, t, n, i, s, a, o, c, l, d, u) {
        var h,
          p,
          f,
          m,
        ...
        for (
          ...
          null != (f = n.__k[h]) &&
            ...
            (f.__i = h),
            (w = L(e, f, p, s, a, o, c, l, d, u)),
            (m = f.__e),
            f.ref &&
              p.ref != f.ref &&
              (p.ref && j(p.ref, null, f), u.push(f.ref, f.__c || m, f)),
            null == y && null != m && (y = m),
            4 & f.__u || p.__k === f.__k
              ? (l = (function e(t, n, i) {
                  var r, s;
      ...
      function L(e, t, n, s, a, o, c, l, d, u) {
        var h,
          p,
          f,
          m,
        ...
        128 & n.__u && ((d = !!(32 & n.__u)), (o = [(l = t.__e = n.__e)])),
          (h = r.__b) && h(t);
                    ...
                    l ||
                      ...
                      "progress" == I && null == _
                        ...
                        : void 0 === _ ||
                          ...
                          N(e, u, _, w[u], a),
                      (u = "checked"),
                      void 0 !== y && y !== e[u] && N(e, u, y, w[u], a));
                  }
                  return e;
                })(n.__e, t, n, s, a, o, c, d, u));
    ...
    58646: (e, t, n) => {
      ...
      function w(e, t) {
        var n = _(i++, 3);
        !d.__s && L(n.__H, t) && ((n.__ = e), (n.i = t), r.__H.__h.push(n));
      }
      function v(e, t) {
        var n = _(i++, 4);
        !d.__s && L(n.__H, t) && ((n.__ = e), (n.i = t), r.__h.push(n));
      }
      function k(e) {
        return (
          (c = 5),
      ...
      function d(e, t) {
        ...
        if ("bytes" === e)
          return (
            ...
            t.length % 32 != 0 &&
              (u = i.concat([u, r.zeros(32 - (t.length % 32))])),
            u
          );
    ...
    22361: (e, t, n) => {
      ...
      function O(e) {
        if ("string" == typeof e) {
          let t = R(e).toLowerCase();
          if (T(t) && 40 === t.length) return y(L(t));
        }
      ...
      class eo {
        ...
        async request(e) {
          var t;
          if (0 === this.accounts.length) throw u.provider.unauthorized();
          switch (e.method) {
        ...
        updateChain(e, t) {
          ...
          return (
            ...
            (r !== this.chain &&
              ...
              null === (n = this.callback) ||
                void 0 === n ||
                n.call(this, "chainChanged", D(r.id))),
            !0)
          );
        }
      }
      ...
      class ev {
        constructor(e, t, n, i = !1) {
          (this.storage = e),
            (this.id = t),
            (this.secret = n),
            (this.key = (0, e_.My)((0, eg.sc)(`${t}, ${n} WalletLink`))),
            (this._linked = !!i);
        }
        static create(e) {
      ...
      let eM = (e) =>
        ...
        eA = ({ autoExpand: e, message: t, menuItems: n }) => {
          let [i, r] = (0, eS.useState)(!0),
            [s, a] = (0, eS.useState)(null != e && e);
          return (
            (0, eS.useEffect)(() => {
              let e = [
                window.setTimeout(() => {
      ...
      class eP {
        constructor() {
          (this.attached = !1), (this.snackbar = new ex());
        }
        attach() {
          if (this.attached)
      ...
      class eT {
        ...
        subscribe() {
          let e = ev.load(this.storage) || ev.create(this.storage),
            ...
            i = this.isMobileWeb ? new eL() : new eP();
        ...
        requestEthereumAccounts() {
          ...
          return new Promise((e, t) => {
            this.relayEventManager.callbacks.set(i, (n) => {
              ...
              eT.accountRequestCallbackIds.add(i),
      ...
      class eW {
        constructor(e) {
          (this._relay = null),
            (this._addresses = []),
            (this.metadata = e.metadata),
            (this._storage = new i("walletlink", eR)),
        ...
        get jsonRpcUrl() {
          var e;
          return null !== (e = this._storage.getItem(eU)) && void 0 !== e
            ? e
            : void 0;
        }
        set jsonRpcUrl(e) {
        ...
        async addEthereumChain(e) {
          ...
          let s = this.initializeRelay(),
            ...
            h = await s.addEthereumChain(r.toString(), a, l, o, c, d);
          if (ed(h)) return !1;
          if (
        ...
        getChainId() {
          ...
          return Number.parseInt(
            null !== (e = this._storage.getItem(eO)) && void 0 !== e ? e : "1",
            10
          );
        }
      ...
      async function eF(e, t, n) {
        ...
        let i = new eW({ metadata: t, callback: n });
        e.postMessage({
...
Please see https://www.smartwallet.dev/guides/tips/popup-tips#cross-origin-opener-policy for more information.`,
                ...
                (function (e) {
                  let t = (function (e, { shouldIncludeStack: t = !1 } = {}) {
                      ...
                      return (
                        ...
                        (s[n.toString()] || ((i = n) >= -32099 && i <= -32e3))
                          ? ((u.code = e.code),
                            e.message && "string" == typeof e.message
                              ? ((u.message = e.message),
                                l(e, "data") && (u.data = e.data))
                              : ((u.message = o(u.code)),
                                (u.data = { originalError: c(e) })))
                          : ((u.code = r.rpc.internal),
                            (u.message = d(e, "message") ? e.message : a),
                            (u.data = { originalError: c(e) })),
                        t && (u.stack = d(e, "stack") ? e.stack : void 0),
                        u
                      );
                    })(
                      (function (e) {
        ...
        initSigner(e) {
          return (function (e) {
            ...
            switch (t) {
              ...
              case "walletlink":
                return new eW({ metadata: n, callback: r });
            }
          })({
            signerType: e,
            metadata: this.metadata,
      ...
      function eX(e) {
        var t;
        new i("CBWSDK").setItem("VERSION", ee), eB();
        let n = {
          metadata: {
